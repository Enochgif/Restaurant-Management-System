...
class Resturant:
    def __init__(self, company_name, company_slogan, resturant_Location):
    ...
    def add_feed(self, feed):
        self.customer_feed.append(feed)
    ...
    def display_company_details(self):
        ...
        print(f"We are located at...{resturant_Location}")
        print("What will you love to do today\n")
    ...
    def display_customer_feedback(self):
        for feeds in self.customer_feed:
            print('```````````````````')
            feeds.display_customer_feeds()
...
class Order:
    ...
    def pay_bills(self):
        ...
        payment = self.acount_balance - total_ordering
        if payment > 0:
...
class Feedback:
    def __init__(self, customer):
        self.customer_feeback = ""
        self.customer = customer
        self.customer_feeback +=customer

    def display_customer_feed(self):
        print("\n")
        print("-------Customer feedback---------")
        print(self.customer_feedback, name)
        print("your feedback has been sent successfully")

print("**********************************************")
resturant_name = input("Enter your Restaurant Name: "). title()
resturant_slogan = input("Enter Restuarant Motto: ").lower()
resturant_Location = input("Enter Restuarant Location: ").lower()
restaurant = Resturant(resturant_name, resturant_slogan, resturant_Location)
print()
...
if menu_box:
    ...
    two = "2. choose food"
    three = "3. Remove Menu"
    four = "4. Add more items"
    five = "5. Remove items"
    six = "6. Order "
    seven = "7. See more about us"
    eight = "8. Feedback/Contact "
    decorator = "-------------------------------------"
    print(one, two, three, four, five, six, seven,eight,decorator, sep = "\n")
...
while True:
    ...
    if response == 6:
        while True:
            print(f"Here are the items availble at {resturant_name} Restuarant. \nOrder now ! at 30%  discount :) ")
    ...
    if response == 8:
        ...
        if message == "yes":
            ...
            print("We have recieved your message and it wil be delivered", (glad))
            print("- - - - - - - - - - - - - - - - - - - - - -")
